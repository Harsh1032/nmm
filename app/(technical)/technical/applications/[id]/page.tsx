...
import ApplicationDecisionForm from "@/components/technical/ApplicationDecisionForm";
      ...
      <div className="mx-auto max-w-6xl">
        <header className="border-b border-[#dfe3e8] pb-6">
          ...
          <p className="mt-2 text-sm text-[#667085]">
            Review submitted migration information and issue a processing
            decision.
          </p>
        </header>
        ...
        <div className="mt-7 grid gap-6 lg:grid-cols-[minmax(0,1fr)_380px]">
          <div className="space-y-6">
            ...
            <section className="rounded-xl border bg-white p-6">
              <h2 className="font-bold">Migration Details</h2>
            ...
            {application.decision_reason && (
              <section className="rounded-xl border border-orange-200 bg-orange-50 p-6">
                <h2 className="font-bold">Review Feedback</h2>
